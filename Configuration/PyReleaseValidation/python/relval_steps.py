...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_8_1_0_pre9_Geant4102-81X_mcRun2_asymptotic_v2-v1',     # 3 - 13 TeV samples with GEN-SIM from 810pre9G4102; also GEN-SIM-DIGI-RAW-HLTDEBUG for id tests
    'CMSSW_7_3_0_pre1-PRE_LS172_V15_FastSim-v1',                   # 4 - fast sim GEN-SIM-DIGI-RAW-HLTDEBUG for id tests
    'CMSSW_8_1_0_pre9_Geant4102-PU25ns_81X_mcRun2_asymptotic_v2-v1',     # 5 - fullSim PU 25ns premix for 810pre9G4102
    'CMSSW_8_1_0_pre9_Geant4102-PU50ns_81X_mcRun2_startup_v2-v1',        # 6 - fullSim PU 50ns premix for 810pre9G4102
    ...
    'CMSSW_8_1_0_pre9_Geant4102-81X_mcRun2cosmics_startup_peak_v2-v1', # 12 - GEN-SIM input for 1307 cosmics wf from 810p9_G4102
    ]
