...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_8_1_0_pre16-PU25ns_81X_mcRun2_asymptotic_v11-v1',    # 5 - fullSim PU 25ns premix from 810_p16
    'CMSSW_8_1_0_pre16-PU50ns_81X_mcRun2_startup_v12-v1',        # 6 - fullSim PU 50ns premix from 810_p16 
    'CMSSW_8_1_0_pre16-81X_mcRun2_asymptotic_v11_FastSim-v1',    # 7 - fastSim MinBias for mixing from 810_p16
    ...
    'CMSSW_8_1_0_pre9_Geant4102-81X_mcRun2cosmics_startup_peak_v2-v1', # 12 - GEN-SIM input for 1307 cosmics wf from 810_p9_G4102
    ]
...
defaultDataSets={}
defaultDataSets['2017']='CMSSW_8_1_0_pre15-81X_upgrade2017_realistic_v17_BpixFpixHcalGeom-v'
defaultDataSets['2017Design']='CMSSW_8_1_0_pre15-81X_upgrade2017_design_IdealBS_v1_2017design-v'
